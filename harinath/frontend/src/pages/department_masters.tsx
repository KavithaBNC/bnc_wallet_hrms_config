      ...
      {modalType && (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          <div className="relative bg-white rounded-xl shadow-2xl w-full max-w-md mx-4 overflow-hidden">
            {/* Header */}
            <div className={`px-6 py-4 bg-gradient-to-r ${modalColor === 'blue' ? 'from-blue-500 to-blue-600' : modalColor === 'purple' ? 'from-purple-500 to-purple-600' : 'from-blue-500 to-blue-600'}`}>
            ...
            <div className="px-6 py-4 bg-gray-50 flex justify-end gap-3">
              ...
              <button onClick={handleModalSubmit} disabled={modalLoading || !modalName.trim()}
                className={`px-4 py-2 text-sm font-medium text-white rounded-lg disabled:opacity-50 transition ${modalColor === 'blue' ? 'bg-blue-600 hover:bg-blue-700' : modalColor === 'purple' ? 'bg-purple-600 hover:bg-purple-700' : 'bg-blue-600 hover:bg-blue-700'}`}>
                {modalLoading ? (
