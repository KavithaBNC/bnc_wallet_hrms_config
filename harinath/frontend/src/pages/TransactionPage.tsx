  ...
  const subModules = [
    {
      ...
      label: 'Increment',
      description: 'View and manage increment records.',
      icon: (
    ...
    {
      to: '/transaction/paygroup-transfer',
      label: 'Pay group Transfer',
      description: 'View and manage pay group transfers for employees.',
      icon: (
        <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
