...
export const APP_MODULES: AppModule[] = [
  ...
  { path: '/department-masters', label: 'Masters Bulk Upload', resource: 'departments', visibility: 'all' },
  ...
  { path: '/attendance/management', label: 'Attendance Management', resource: 'attendance', visibility: 'all', parentPath: '/attendance' },
  { path: '/attendance/face', label: 'Face Attendance', resource: 'attendance', visibility: 'all', parentPath: '/attendance' },
  { path: '/device-setting', label: 'Device Setting', resource: 'attendance', visibility: 'all' },
  { path: '/leave/excess-time-request', label: 'Excess Time Request', resource: 'leaves', visibility: 'all', parentPath: '/leave' },
  { path: '/leave/excess-time-approval', label: 'Excess Time Approval', resource: 'leaves', visibility: 'all', parentPath: '/leave' },
  ...
  { path: '/leave/apply-event', label: 'Apply Event', resource: 'leaves', visibility: 'all', parentPath: '/leave' },
  { path: '/leave/requests', label: 'Requests', resource: 'leaves', visibility: 'all', parentPath: '/leave' },
  { path: '/leave/approvals', label: 'Approvals', resource: 'leaves', visibility: 'all', parentPath: '/leave' },
  { path: '/leave/balance-entry', label: 'Balance Entry', resource: 'leaves', visibility: 'all', parentPath: '/leave' },
  ...
  { path: '/payroll/employee-separation', label: 'Employee Separation', resource: 'employee_separations', visibility: 'all', parentPath: '/payroll' },
  { path: '/payroll/employee-rejoin', label: 'Employee Rejoin', resource: 'employee_rejoin', visibility: 'all', parentPath: '/payroll' },
  { path: '/payroll/fnf-settlement', label: 'FnF Settlement', resource: 'payroll', visibility: 'all', parentPath: '/payroll' },
  { path: '/payroll/loans', label: 'Loans', resource: 'payroll', visibility: 'all', parentPath: '/payroll' },
